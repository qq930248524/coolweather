...
public class ManageCountyListViewAdapter extends ArrayAdapter<StarCounty> {
	...
	public ManageCountyListViewAdapter(Context context, ListView listView, int resource, List<StarCounty> objects, CoolWeatherDB db) {
